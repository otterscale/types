/** Generated from Remote JSON Schema for snapshot.kubevirt.io.v1alpha1.VirtualMachineRestore */

/**
 * VirtualMachineRestore defines the operation of restoring a VM
 */
export interface SnapshotKubevirtIoV1Alpha1VirtualMachineRestore {
  /**
