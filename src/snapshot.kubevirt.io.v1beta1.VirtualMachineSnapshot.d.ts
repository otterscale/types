/** Generated from Remote JSON Schema for snapshot.kubevirt.io.v1beta1.VirtualMachineSnapshot */

/**
 * VirtualMachineSnapshot defines the operation of snapshotting a VM
 */
export interface SnapshotKubevirtIoV1Beta1VirtualMachineSnapshot {
  /**
