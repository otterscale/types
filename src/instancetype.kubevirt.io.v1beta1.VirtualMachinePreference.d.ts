/** Generated from Remote JSON Schema for instancetype.kubevirt.io.v1beta1.VirtualMachinePreference */

/**
 * VirtualMachinePreference resource contains optional preferences related to the VirtualMachine.
 */
export interface InstancetypeKubevirtIoV1Beta1VirtualMachinePreference {
  /**
