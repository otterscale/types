/** Generated from Remote JSON Schema for snapshot.kubevirt.io.v1alpha1.VirtualMachineSnapshotContent */

/**
 * VirtualMachineSnapshotContent contains the snapshot data
 */
export interface SnapshotKubevirtIoV1Alpha1VirtualMachineSnapshotContent {
  /**
