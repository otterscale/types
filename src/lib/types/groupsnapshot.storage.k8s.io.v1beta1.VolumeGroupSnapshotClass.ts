/** Generated from Remote JSON Schema for groupsnapshot.storage.k8s.io.v1beta1.VolumeGroupSnapshotClass */
 ...
 */
export interface GroupsnapshotStorageK8SIoV1Beta1VolumeGroupSnapshotClass {
  /**
