/** Generated from Remote JSON Schema for kubevirt.io.v1alpha3.VirtualMachineInstanceReplicaSet */

/**
 * VirtualMachineInstance is *the* VirtualMachineInstance Definition. It represents a virtual machine in the runtime environment of kubernetes.
 */
export interface KubevirtIoV1Alpha3VirtualMachineInstanceReplicaSet {
  /**
