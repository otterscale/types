/** Generated from Remote JSON Schema for serving.kserve.io.v1alpha1.LLMInferenceServiceConfig */

export interface ServingKserveIoV1Alpha1LLMInferenceServiceConfig {
  /**
  ...
  spec?: {
    ...
    model?: {
      criticality?: 'Critical' | 'Standard' | 'Sheddable';
      lora?: {
        adapters?: {
          [k: string]: unknown;
        };
