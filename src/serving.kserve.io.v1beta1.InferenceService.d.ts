/** Generated from Remote JSON Schema for serving.kserve.io.v1beta1.InferenceService */

export interface ServingKserveIoV1Beta1InferenceService {
  /**
    ...
    explainer?: {
      ...
      autoScaling?: {
        ...
        metrics?: {
          ...
          type: 'Resource' | 'External' | 'PodMetric';
          [k: string]: unknown;
        }[];
        [k: string]: unknown;
      };
      ...
      scaleMetricType?: 'Utilization' | 'Value' | 'AverageValue';
      scaleTarget?: number;
  ...
  status?: {
    ...
    modelStatus?: {
      ...
      states?: {
        activeModelState: '' | 'Pending' | 'Standby' | 'Loading' | 'Loaded' | 'FailedToLoad';
        targetModelState?: '' | 'Pending' | 'Standby' | 'Loading' | 'Loaded' | 'FailedToLoad';
        [k: string]: unknown;
      };
