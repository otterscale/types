/** Generated from Remote JSON Schema for serving.kserve.io.v1alpha2.LLMInferenceServiceConfig */

export interface ServingKserveIoV1Alpha2LLMInferenceServiceConfig {
  /**
