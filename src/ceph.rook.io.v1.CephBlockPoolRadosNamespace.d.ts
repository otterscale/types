/** Generated from Remote JSON Schema for ceph.rook.io.v1.CephBlockPoolRadosNamespace */

/**
 * CephBlockPoolRadosNamespace represents a Ceph BlockPool Rados Namespace
 */
export interface CephRookIoV1CephBlockPoolRadosNamespace {
  /**
