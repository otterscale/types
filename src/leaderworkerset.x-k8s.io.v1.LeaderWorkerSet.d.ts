/** Generated from Remote JSON Schema for leaderworkerset.x-k8s.io.v1.LeaderWorkerSet */

/**
 * LeaderWorkerSet is the Schema for the leaderworkersets API
 */
export interface LeaderworkersetXK8SIoV1LeaderWorkerSet {
  /**
  ...
  spec?: {
    ...
    leaderWorkerTemplate: {
       ...
       */
      restartPolicy?: 'Default' | 'RecreateGroupOnPodRestart' | 'None';
      /**
      ...
      subGroupPolicy?: {
         ...
         * LeaderWorker
         */
        subGroupPolicyType?: 'LeaderWorker' | 'LeaderExcluded';
        /**
    ...
    networkConfig?: {
       ...
       */
      subdomainPolicy: 'Shared' | 'UniquePerReplica';
      [k: string]: unknown;
    };
    /**
