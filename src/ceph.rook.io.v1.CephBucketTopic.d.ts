/** Generated from Remote JSON Schema for ceph.rook.io.v1.CephBucketTopic */

/**
 * CephBucketTopic represents a Ceph Object Topic for Bucket Notifications
 */
export interface CephRookIoV1CephBucketTopic {
  /**
  ...
  spec: {
    ...
    endpoint: {
      ...
      amqp?: {
         ...
         */
        ackLevel?: 'none' | 'broker' | 'routeable';
        /**
      ...
      kafka?: {
         ...
         */
        mechanism?: 'PLAIN' | 'SCRAM-SHA-512' | 'SCRAM-SHA-256' | 'GSSAPI' | 'OAUTHBEARER';
        /**
