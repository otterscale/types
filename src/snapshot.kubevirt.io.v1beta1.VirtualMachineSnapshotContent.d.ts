/** Generated from Remote JSON Schema for snapshot.kubevirt.io.v1beta1.VirtualMachineSnapshotContent */

/**
 * VirtualMachineSnapshotContent contains the snapshot data
 */
export interface SnapshotKubevirtIoV1Beta1VirtualMachineSnapshotContent {
  /**
